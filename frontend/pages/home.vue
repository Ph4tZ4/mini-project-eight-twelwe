    ...
    <section id="products" class="py-20 bg-black">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
          ...
          <!-- Products -->
          <div v-else v-for="product in homeData.featured_products" :key="product.id" class="bg-gray-900 rounded-lg overflow-hidden hover:transform hover:scale-105 transition-transform duration-300 cursor-pointer" @click="viewProduct(product.id)">
