      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
          ...
          <div v-else v-for="product in homeData.featured_products" :key="product.id" class="bg-gray-900 rounded-lg overflow-hidden hover:transform hover:scale-105 transition-transform duration-300">
            <div class="h-64 bg-gradient-to-br from-gray-700 to-gray-800 flex items-center justify-center cursor-pointer" @click="viewProduct(product.id)">
            ...
            <div class="p-6">
              <h3 class="text-lg font-semibold text-white mb-2 cursor-pointer hover:text-gray-300 transition-colors" @click="viewProduct(product.id)">{{ product.name }}</h3>
              ...
              <div class="flex justify-between items-center">
                ...
                <button @click="viewProduct(product.id)" class="bg-white text-black px-4 py-2 rounded-md hover:bg-gray-200 transition-colors flex items-center gap-2">
